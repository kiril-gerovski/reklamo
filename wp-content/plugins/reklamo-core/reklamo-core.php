...
require REKLAMO_PATH . 'includes/class-reklamo-filetypes.php';
require REKLAMO_PATH . 'includes/class-reklamo-svg.php';
require REKLAMO_PATH . 'includes/class-reklamo-storage.php';
require REKLAMO_PATH . 'includes/class-reklamo-upload.php';
...
function reklamo_boot(): void {
	...
	Reklamo_Reminders::init();
	Reklamo_Upload::init();
	Reklamo_Cleanup::init();
	Reklamo_Diagnostics::init();
}
